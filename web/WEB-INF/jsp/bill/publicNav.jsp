...
<ul class="nav nav-tabs ">
	<li <c:if test="${param.billType=='today'}">class="active"</c:if>><a
		href="${pageContext.request.contextPath }/todayBill.html?billType=today&show=bill" >Today</a></li>
	<li role="presentation"
		...
		aria-haspopup="true" aria-expanded="false"> History<span class="caret"></span>
	</a>
		<ul class="dropdown-menu">
			<li class="<c:if test="${param.billType=='year'}">active</c:if>"><a href="${pageContext.request.contextPath }/yearBill.html?billType=year&show=bill" >Year</a></li>
			<li class="<c:if test="${param.billType=='month'}">active</c:if>"><a href="${pageContext.request.contextPath }/monthBill.html?billType=month&show=bill" >Month</a></li>
			<li class="<c:if test="${param.billType=='date'}">active</c:if>"><a href="${pageContext.request.contextPath }/dateBill.html?billType=date&show=bill&opr=date" >Date</a></li>
		</ul></li>
