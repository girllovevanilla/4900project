	...
	<input type="hidden"  id="path" path="${pageContext.request.contextPath }" />
		<div class="adjust-nav">
			...
			<span class="logout-spn">
			 <a href="javascript:;" style="color:#fff;">Operator:${user.userName }</a>
				<p class="text-right"><a href="${pageContext.request.contextPath}/logout.html" style="color:white;font-size: 14px;">Login Out</a></p>
			</span>
			</div>
		</div>
	</div>
			...
			<ul class="nav" id="main-menu">
				<li><a
					...
					<c:if test="${param.show=='desk' }">class="active-link"</c:if>><i
						class="fa fa-desktop "></i>Table</a></li>
				<li><a
