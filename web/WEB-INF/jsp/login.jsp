	...
	<div id="wrapper">
		<form class="from-group"  id="loginForm" action="${pageContext.request.contextPath}/login.html"
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 " id="logbox">
				<p class="h1 text-center title">Restaurant cash register management system</p>
				<h2>Login:<span style="color:red;font-size: 12px;">${error}</span></h2>
				<div class="input-group">
					<span class="input-group-addon"><span
						class="glyphicon glyphicon-user
			"></span></span> <input type="text"
						id="userCode" name="userCode" class="form-control" placeholder="UserName"
			...
			"></span></span> <input
						...
						placeholder="PassWord" required="required" pattern="^[a-zA-Z0-9_-]{6,18}$" />
				</div>
				<br />
				<div class="row">
