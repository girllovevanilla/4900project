...
public class RedisUtil {
	...
	public void add(String key, String value) {
		if (redisTemplate == null) {
			logger.warning("redisTemplate Instantiation failure");
			return;
		} else {
			redisTemplate.opsForValue().set(key, value);
			logger.info("Add Successfully------><"+key+","+value+">");
		}
	}
	...
	public void addObj(String key, Object obj) {
		if (redisTemplate == null) {
			...
			logger.info("Add Successfully------><"+key+","+objJson+">");
		}
	}
	...
	public void addList(String key,List list){
		if (redisTemplate == null) {
			...
			logger.info("Add Successfully------><"+key+","+listJson+">");
		}		
	}
